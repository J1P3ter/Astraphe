...
//        return "Reduce Message is sent";
//    }
//
//    @GetMapping("/rollback")
//    public String kafkarollBackTest(
//            @RequestHeader(name = "X-USER-ID") Long userId,
//            @RequestParam Long productId,
//            @RequestParam Integer quantity
//    ){
//        String topic = "rollback-stock";
//        RollbackStockEvent event = new RollbackStockEvent(0, 1L, productId, quantity);
//        Message<String> kafkaMessage = MessageBuilder
//                .withPayload(EventSerializer.serialize(event))
//                .setHeader(KafkaHeaders.TOPIC, topic)
//                .setHeader("X-USER-ID", userId)
//                .build();
//        kafkaTemplate.send(kafkaMessage);
//        return "Rollback Message is sent";
//    }
}
